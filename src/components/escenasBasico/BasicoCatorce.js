...
class BasicoCatorce extends Phaser.Scene {
    constructor() {
        super({ key: "BasicoCatorce" });
    }
    preload() {
    }
    create(){
        ...
        const respuestaCorrecta = Phaser.Math.RND.pick(respuestas.respuestasCorrectasSiete);  ; // Obtener la respuesta correcta del JSON
        const respuestaIncorrecta = Phaser.Math.RND.pick(respuestas.respuestasIncorrectasSiete); // Obtener la respuesta incorrecta del JSON
        let respuestaIncorrectaDos = Phaser.Math.RND.pick(respuestas.respuestasIncorrectasSiete); // Obtener la respuesta incorrecta del JSON
        while (respuestaIncorrecta === respuestaIncorrectaDos) {
            respuestaIncorrectaDos = Phaser.Math.RND.pick(respuestas.respuestasIncorrectasSiete); // Obtener la respuesta incorrecta del JSON
        }
        ...
        const caja = this.add.image(500, 300, "memoriaCaja");
        ...
        flecha.on('pointerdown', () => {
            sonidos.musicaFlecha.play(); // Reproducir el sonido de abrir puerta
       ...
       const opciones = {
        ...
        pregunta.on('pointerdown', () => {
            ...
            Swal.fire({
              ...
              html: `<h5><strong>¡Selecciona la afirmacion correcta sobre la memoria RAM!</strong></h5>`,
              input: 'radio',
              ...
              preConfirm: (respuesta) => {
                ...
                sonidos.no.play(); // Reproducir el sonido de incorrecto
                ...
                Swal.fire({
                 ...
                 sonidos.si.play(); // Reproducir el sonido de correcto
                 Swal.fire({
                 showClass: {
                    popup: `
                        animate__animated
                 ...
                 hideClass: {
                  ...
                  title: '¡Sobresaliente!',
                  html: `<p>Lo logramos, tenemos La memoria RAM. ¡Al siguiente componente!</p>`,
                  confirmButtonText: 'Continuar',
                  allowOutsideClick: false,
                  imageUrl:'assets/MemoriaRAM.png', // Ruta de la imagen;
                  imageWidth: 200, // Ancho de la imagen
                  imageHeight: 115, // Alto de la imagen
                  imageAlt: 'Exclamación', // Texto alternativo
                }).then((result) => {
                  if (result.isConfirmed) {
                    sonidos.vamos.play(); // Reproducir el sonido de correcto
                    this.cameras.main.fadeOut(500, 0, 0, 0);
                    this.cameras.main.once('camerafadeoutcomplete', () => {
        ...
        libro.on('pointerdown', () => {
            ...
            Swal.fire({
                showClass: {
                 ...
                 html:`<p>La memoria RAM, o Memoria de Acceso Aleatorio, es como el espacio de trabajo temporal de tu computadora.
                 Cuando abres un programa o archivo, se carga en la RAM para que el procesador pueda acceder a él rápidamente y
                 realizar las tareas necesarias. Es mucho más rápida que el almacenamiento permanente, pero también es volátil,
                 lo que significa que pierde su contenido al apagar el equipo. Cuanta más RAM tenga tu computadora,
                 más programas podrá manejar al mismo tiempo sin volverse lenta.</p>`,
                 confirmButtonText: 'Continuar',
                 allowOutsideClick: false,
