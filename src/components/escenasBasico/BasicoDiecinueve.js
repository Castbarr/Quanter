...
class BasicoDiecinueve extends Phaser.Scene{
    constructor(){
        super({ key: "BasicoDiecinueve" });
    }
    preload(){
    }
    create(){
        ...
        const discoCaja = this.add.image(260, 330, 'refrigeracionCaja').setInteractive();
        ...
        discoCaja.on('pointerdown', () => {
            ...
            Swal.fire({
                ...
                html: `<p>Solo ocupo el ventilador. ¡A desbloquear la caja!</p>`,
...
export default BasicoDiecinueve;